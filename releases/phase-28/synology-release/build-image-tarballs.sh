...
# Remove stale phase-specific tags if they exist locally so they do not bleed
# into saved tarballs sharing the same image digest.
for stale in pirate-claw-phase27:latest pirate-claw-phase28:latest \
             "pirate-claw-phase27:${VERSION}" "pirate-claw-phase28:${VERSION}" \
             pirate-claw-web-phase27:latest pirate-claw-web-phase28:latest \
             "pirate-claw-web-phase27:${VERSION}" "pirate-claw-web-phase28:${VERSION}"; do
