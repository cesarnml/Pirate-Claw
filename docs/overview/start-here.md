...
Delivery artifacts for phases land under [`docs/product/delivery/`](../02-delivery/). Product specs live under [`docs/product/plans/`](../01-product/).
...
2. Read [`docs/overview/roadmap.md`](./roadmap.md).
3. Read the relevant product doc under `docs/product/plans/`.

If you are planning or revising a phase:

1. Read the relevant product doc under `docs/product/plans/`.
2. Read [`docs/product/delivery/phase-implementation-guidance.md`](../02-delivery/phase-implementation-guidance.md).
3. Read or update the relevant `docs/product/delivery/<phase>/implementation-plan.md`.
...
1. Read [`docs/product/delivery/phase-implementation-guidance.md`](../02-delivery/phase-implementation-guidance.md).
2. Read [`docs/engineering/delivery-orchestrator.md`](../03-engineering/delivery-orchestrator.md) if the work touches stacked delivery flow.
...
If a request arrives to implement new product scope without a completed planning pass and developer-approved ticket decomposition, surface the missing control point, point here and to `docs/product/delivery/phase-implementation-guidance.md`, and wait for the developer to close the gap before proceeding.
...
- [`docs/product/delivery/phase-implementation-guidance.md`](../02-delivery/phase-implementation-guidance.md)
...
- `docs/product/plans/`: product goals and phase scope
- `docs/product/delivery/`: implementation plans, tickets, and delivery guidance
- `docs/engineering/`: engineering workflow and supporting technical notes
- `docs/decisions/`: ADRs and durable technical decisions
