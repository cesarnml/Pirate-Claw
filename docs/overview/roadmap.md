...
- `docs/product/plans/phase-02-real-world-feed-compatibility.md`
- `docs/product/plans/phase-03-post-queue-lifecycle.md`
...
- `docs/product/plans/phase-04-always-on-local-runtime.md`
- `docs/product/delivery/phase-04/implementation-plan.md`
...
- `docs/product/plans/phase-05-intake-policy-and-routing.md`
...
- The historical Phase 06 validation artifact remains at `docs/product/delivery/phase-06/synology-runbook.md`.
...
- `docs/product/plans/phase-07-config-ergonomics.md`
...
- implemented on `main`
- covers ticket stack `EE4.01`-`EE4.04` under `docs/product/delivery/engineering-epic-04/`
...
- `docs/product/plans/phase-08-media-placement.md`
...
- `docs/product/plans/phase-09-daemon-http-api.md`
- `docs/product/delivery/phase-09/implementation-plan.md`
...
- `docs/product/plans/phase-10-read-only-dashboard.md`
...
- implemented on `main` per approved tickets `P11.01`–`P11.06` in [`docs/product/delivery/phase-11/implementation-plan.md`](../02-delivery/phase-11/implementation-plan.md) (delivered via the stacked PR workflow and `closeout-stack` merge)
...
- `docs/product/plans/phase-11-tmdb-metadata-enrichment.md`
- `docs/product/delivery/phase-11/implementation-plan.md`
...
- delivered (stacked PRs) — see [`docs/product/delivery/phase-12/implementation-plan.md`](../02-delivery/phase-12/implementation-plan.md) and [`docs/product/plans/phase-12-dashboard-design-system-and-read-ui.md`](../01-product/phase-12-dashboard-design-system-and-read-ui.md)
...
- `docs/product/plans/phase-12-dashboard-design-system-and-read-ui.md`
...
- `docs/product/plans/phase-13-daemon-config-write-api-and-settings.md`
...
- implemented on `main` via `P14.01`–`P14.06` stacked delivery; see [`docs/product/delivery/phase-14/implementation-plan.md`](../02-delivery/phase-14/implementation-plan.md) and [`docs/product/plans/phase-14-feed-setup-and-target-management.md`](../01-product/phase-14-feed-setup-and-target-management.md)
...
- implemented on `main` via `P15.01`–`P15.07` stacked delivery; see [`docs/product/delivery/phase-15/implementation-plan.md`](../02-delivery/phase-15/implementation-plan.md) and [`docs/product/plans/phase-15-rich-visual-state-and-activity-views.md`](../01-product/phase-15-rich-visual-state-and-activity-views.md)
...
- implemented on `main` via `P16.01`-`P16.09` stacked delivery; see [`docs/product/delivery/phase-16/implementation-plan.md`](../02-delivery/phase-16/implementation-plan.md) and [`docs/product/plans/phase-16-config-editing-hot-reload-and-daemon-controls.md`](../01-product/phase-16-config-editing-hot-reload-and-daemon-controls.md)
...
- implemented on `main` via `P17.01`-`P17.07` stacked delivery; see [`docs/product/delivery/phase-17/implementation-plan.md`](../02-delivery/phase-17/implementation-plan.md) and [`docs/product/plans/phase-17-onboarding-and-empty-state.md`](../01-product/phase-17-onboarding-and-empty-state.md)
...
- `docs/product/plans/phase-18-plex-media-server-enrichment.md`
- `docs/product/delivery/phase-18/implementation-plan.md`
...
- `docs/product/plans/phase-19-ui-redesign-razzle-dazzle.md`
- `docs/product/delivery/phase-19/implementation-plan.md`
...
- shipped on `main`; product contract: [`docs/product/plans/phase-20-dashboard-torrent-actions.md`](../01-product/phase-20-dashboard-torrent-actions.md)
- delivery record: [`docs/product/delivery/phase-20/implementation-plan.md`](../02-delivery/phase-20/implementation-plan.md)
...
- product definition only; see [`docs/product/plans/phase-21-bootstrap-contract.md`](../01-product/phase-21-bootstrap-contract.md)
...
- product definition only; see [`docs/product/plans/phase-22-browser-only-setup.md`](../01-product/phase-22-browser-only-setup.md)
...
- see [`docs/product/plans/phase-25-in-browser-restart-round-trip-proof.md`](../01-product/phase-25-in-browser-restart-round-trip-proof.md)
...
- see [`docs/product/plans/phase-26-mac-first-class-always-on-deployment.md`](../01-product/phase-26-mac-first-class-always-on-deployment.md)
...
- product contract: [`docs/product/plans/phase-27-synology-dsm-first-stack-and-cold-start.md`](../01-product/phase-27-synology-dsm-first-stack-and-cold-start.md)
- delivery record: [`docs/product/delivery/phase-27/implementation-plan.md`](../02-delivery/phase-27/implementation-plan.md)
...
- see [`docs/product/plans/phase-28-owner-web-security.md`](../01-product/phase-28-owner-web-security.md)
...
- product definition only; see [`docs/product/plans/phase-29-openvpn-bridge-for-bundled-transmission.md`](../01-product/phase-29-openvpn-bridge-for-bundled-transmission.md)
...
- product definition only; see [`docs/product/plans/phase-30-ux-ui-polish-after-functional-completion.md`](../01-product/phase-30-ux-ui-polish-after-functional-completion.md)
...
- product definition only; see [`docs/product/plans/phase-31-v1-release-and-schema-versioning.md`](../01-product/phase-31-v1-release-and-schema-versioning.md)
...
- `docs/engineering/epic-03-delivery-orchestrator-modularity-and-concern-separation.md`
- `docs/product/delivery/engineering-epic-03/implementation-plan.md`
- `docs/engineering/epic-04-reviewer-facing-pr-body-and-thread-hygiene.md`
- `docs/product/delivery/engineering-epic-04/implementation-plan.md`
