...
**Delivery status:** Planned — implementation plan and ticket draft exist under `docs/product/delivery/phase-25/`; awaiting developer approval and merge to `main` before delivery starts.
