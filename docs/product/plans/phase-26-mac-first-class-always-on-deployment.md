...
**Delivery status:** Not started — product definition only; no `docs/product/delivery/phase-26/` implementation plan until tickets are approved.
...
- broad UX/UI polish outside deployment/lifecycle work (Phase 30)
