...
**Delivery status:** Delivered in the current stack via `P19.01`–`P19.08` (see [`docs/product/delivery/phase-19/implementation-plan.md`](../02-delivery/phase-19/implementation-plan.md)). This file stays the product-facing design contract; ticket evidence and execution notes live under `docs/product/delivery/phase-19/`.
