...
- Update `docs/overview/roadmap.md` — mark P27 implemented
- Update `docs/overview/start-here.md` — reflect Synology DSM-first as the supported install path

**Retrospective (required):**

- Write `notes/public/phase-27-synology-dsm-first-stack-and-cold-start-retrospective.md` covering:
...
Updated `README.md`, `docs/overview/start-here.md`, and `docs/overview/roadmap.md` to reflect Phase 27 implementation status and to redirect Synology install queries to the new owner doc rather than the old expert runbook.

Phase 27 retrospective written as `notes/public/phase-27-synology-dsm-first-stack-and-cold-start-retrospective.md` covering the `.spk` Docker orchestration finding, DSM folder permission friction, old image/container naming conflicts, the Transmission auth-free RPC constraint, and what P28/P29 planning should verify before assuming the Phase 27 stack topology is safe or Container Manager-portable.
