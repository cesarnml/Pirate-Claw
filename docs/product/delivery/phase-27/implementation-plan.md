...
- [`docs/product/plans/phase-27-synology-dsm-first-stack-and-cold-start.md`](../../01-product/phase-27-synology-dsm-first-stack-and-cold-start.md)
...
- **Artifact:** `notes/public/phase-27-synology-dsm-first-stack-and-cold-start-retrospective.md`
