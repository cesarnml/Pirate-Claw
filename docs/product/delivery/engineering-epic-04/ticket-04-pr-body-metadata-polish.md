...
```
- ticket file: docs/product/delivery/phase-10/ticket-02-candidates-list.md
```

**Target:**

```
- ticket file: [docs/product/delivery/phase-10/ticket-02-candidates-list.md](https://github.com/{owner}/{repo}/blob/main/docs/product/delivery/phase-10/ticket-02-candidates-list.md)
```
