...
- [`docs/product/plans/phase-25-in-browser-restart-round-trip-proof.md`](../../01-product/phase-25-in-browser-restart-round-trip-proof.md)
...
- **Artifact:** `notes/public/phase-25-in-browser-restart-round-trip-proof-retrospective.md`
