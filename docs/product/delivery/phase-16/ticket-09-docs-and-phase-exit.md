...
### `docs/product/plans/phase-16-config-editing-hot-reload-and-daemon-controls.md`

- Update the "Delivery status" line at the top from "Not started — product definition only" to "Delivered — see `docs/product/delivery/phase-16/`".
