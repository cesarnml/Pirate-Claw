...
- **`docs/overview/roadmap.md`:** mark Phase 18 delivered; update active
  phase pointer
- **`docs/overview/start-here.md`:** update delivered scope, commands, and
...
context loss before Phase 30 (v1 release) or any future media-library provider
expansion.
