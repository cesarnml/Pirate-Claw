...
- [`docs/product/plans/phase-23-plex-browser-auth-and-credential-lifecycle.md`](../../01-product/phase-23-plex-browser-auth-and-credential-lifecycle.md)
...
- **Artifact:** `notes/public/phase-23-plex-browser-auth-and-credential-lifecycle-retrospective.md`
