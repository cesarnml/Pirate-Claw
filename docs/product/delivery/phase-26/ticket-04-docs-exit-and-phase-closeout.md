...
- write `notes/public/phase-26-mac-first-class-always-on-deployment-retrospective.md`
- update `README.md` for the final supported Mac always-on story if delivered behavior changed operator guidance materially
- update [`docs/overview/start-here.md`](../../00-overview/start-here.md) and [`docs/overview/roadmap.md`](../../00-overview/roadmap.md) with Phase 26 delivery status and the handoff assumptions for later phases
