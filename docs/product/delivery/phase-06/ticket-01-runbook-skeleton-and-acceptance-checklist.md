...
- create `docs/product/delivery/phase-06/synology-runbook.md` as the single canonical operator-facing runbook
...
- `Implementation note:` the canonical runbook now exists at `docs/product/delivery/phase-06/synology-runbook.md` with operator-journey sections, an explicit acceptance checklist, and a hard split between operator-facing verification cues and ticket-rationale proof.
