...
- [`docs/product/plans/phase-17-onboarding-and-empty-state.md`](../../01-product/phase-17-onboarding-and-empty-state.md)
  - update delivery status from product-definition-only to delivered, with pointer to `docs/product/delivery/phase-17/`
...
- [`docs/overview/start-here.md`](../../00-overview/start-here.md)
  - mark Phase 17 delivered and advance the current planning pointer
- [`docs/overview/roadmap.md`](../../00-overview/roadmap.md)
  - update Phase 17 delivery status and notes
- [`docs/README.md`](../../README.md)
  - list the new Phase 17 delivery artifacts
- [`docs/product/delivery/phase-17/implementation-plan.md`](./implementation-plan.md)
